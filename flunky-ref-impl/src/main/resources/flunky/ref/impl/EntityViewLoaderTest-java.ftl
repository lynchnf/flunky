...
public class ${entityName}ViewLoaderTest {
    private Random rand = new Random();
    private Long id;
<#list fields as field>
    private String ${field.fieldName};
</#list>
    private ${entityName}ViewLoader loader;
...
<#list fields as field>
        ...
        loader = new ${entityName}ViewLoader();
    }
    ...
    public void testDoPostHttpServletRequestHttpServletResponse() throws ServletException, IOException {
        ...
        verify(request).setAttribute(eq("view"), any(${entityName}Form.class));
        verify(request).getRequestDispatcher("${entityName?uncap_first}View.jsp");
