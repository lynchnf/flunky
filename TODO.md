...
- [x] Fix Windows batch file in flunky-main.
- [ ] Test Linux shell script in flunky-main.
...
- [ ] Create implementation using Spring Web MVC and Thymeleaf.

## Long Term Goals

- [ ] Create implementation using Spring Web MVC and Angular.
- [ ] Create implementation using Spring WebFlux and React.
